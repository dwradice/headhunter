...
import { createProfile, getLoggedInProfile } from './../../actions/profile';
    ...
    <Fragment>
      ...
      <form className='form' onSubmit={e => onSubmit(e)}>
        <div className='form-group'>
          ...
          />
          <small className='form-text'>What do you do for work</small>
        </div>
        <div className='form-group'>
          <input
            type='text'
...
export default connect(mapStateToProps, { createProfile, getLoggedInProfile })(
